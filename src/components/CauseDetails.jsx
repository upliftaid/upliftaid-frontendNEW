...
const handleSubmit = (e) => {
  ...
  return (
    <div className="w-full p-4 grid gap-4 h-fit">
        <h1 className="font-medium text-[26px]">CHARITY FOR EDUCATION</h1>
          ...
          <div className="grid gap-6">
            <div className="grid gap-1">
              <h1 className="text-[24px] font-medium">CAUSE DESCRIPTION</h1>
            ...
            <div className="grid">
              <p className="font-medium text-[24px]">CAUSE CONTENT</p>
