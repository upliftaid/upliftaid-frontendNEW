    ...
    return (
      <div className="flex gap-1">
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            key={star}
            className={`max-[445px]:w-3 max-[445px]:h-3 w-5 h-5 ${
              star <= rating 
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg max-[445px]:text-sm font-semibold text-gray-700">
                {averageRating.toFixed(1)} out of 5
              </span>
            </div>
            <span className="text-gray-500 max-[445px]:text-sm">({reviews.length} reviews)</span>
          </div>
        </div>
        <button
