      ...
      {upcomingEvents.map((event, index) => (
        <div className="group flex gap-2 py-2 cursor-pointer" key={index}>
          <img
            src={event.image}
            alt={event.title}
            className="group-hover:scale-110 duration-300 w-20 h-20 object-cover rounded mr-3"
          />
          <div className="flex flex-col gap-2">
            <p className="font-medium text-sm leading-tight mb-2 text-gray-500">{event.title}</p>
