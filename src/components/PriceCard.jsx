    ...
    <div className="mt-10 px-4 md:px-8 lg:px-16 min-w-[320px] lg:w-full ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mt-8 justify-items-center md:grid-cols-2">
        {PriceCardDetails.map((card, index) => {
          ...
          return (
            <div
              className="group w-full max-w-[250px] h-[450px] border border-[#eee] grid place-items-center transition-all duration-300"
              key={card.heading + index}
            >
              <h1 className="text-xl font-semibold mt-4 group-hover:text-[#00adef] transition-all duration-300">
                {card.heading}
              </h1>
              <p>Starting at</p>
              <div className="grid place-items-center">
                <p className="text-[#00adef] text-3xl font-bold">
                  ${card.price}
                </p>
              ...
              <div className="bg-[#00adef] w-[132px] h-13 hover:bg-[#ffb600] flex items-center justify-center hover:text-white text-lg mt-4 cursor-pointer">
