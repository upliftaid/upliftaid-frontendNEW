        ...
        <div className="w-[90%] mx-auto grid gap-4">
          ...
          <div className="p-2 grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-0">
            ...
            <div>
              ...
              <div className="flex flex-col mt-4 gap-2 text-[14px]">
                ...
                <Link to="/about-us" className="hover:text-[#FFB204]">
                  About Us
                </Link>
                <Link to="/" className="hover:text-[#FFB204]">
                  Our Campaigns
                </Link>
                <Link to="/events" className="hover:text-[#FFB204]">
                  Events
                </Link>
                <Link to="/" className="hover:text-[#FFB204]">
            ...
            <div>
              ...
              <div className="flex flex-col mt-4 gap-2 text-[14px]">
                <Link to="/career" className="hover:text-[#FFB204]">
                  Carrers
                </Link>
                <Link to="/contact" className="hover:text-[#FFB204]">
                  Contact Us
                </Link>
                <Link to="/contact" className="hover:text-[#FFB204]">
                  Donate
          ...
          <div className="flex justify-between flex-col md:flex-row">
            ...
            <div className="text-[12px] flex gap-4 mt-4">
              ...
              <Link to="/about-us/faq" className="hover:text-[#FFB204]">
                FAQS
              </Link>
              <div className="w-[1px] h-4 bg-white" />
              <Link to="/" className="hover:text-[#FFB204]">
